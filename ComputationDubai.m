%%%%%%%%%% RUN TIME SERIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load(fullfile('+data_functions', 'TMYDubai_RadPart.mat'))

% Decide if a varying LAI timeseries is provided [1] or not [0]
[LAI_TimeSeries]=data_functions.VaryingLAIInput(0,'LAI_Zurich_Area'); 

n			=	size(TMYDubai,1); % Calculation length, there is no need to change this
m			=	1;					% Length for sensitivity analysis
Name_Site	=	'DU_LCZ3';	% Name for Data_UEHM_site
Name_SiteFD	=	'DU_LCZ3';		% Name for UEHMForcingData
Name_ViewFactor = 'DU_LCZ3';
...
TMYDubai.WindSpeedms(TMYDubai.WindSpeedms(1:n,:)==0) = 0.01;	% Wind speed cannot be 0 otherwise the resistance function fails

MeteoDataRaw	=	struct('LWR_in',TMYDubai.LWRin(1:n,:),'SAB1_in',TMYDubai.SAB1(1:n,:),...
					'SAB2_in',TMYDubai.SAB2(1:n,:),'SAD1_in',TMYDubai.SAD1(1:n,:),...
					'SAD2_in',TMYDubai.SAD2(1:n,:),'T_atm',TMYDubai.TairC(1:n,:)+273.15,...
					'windspeed_u',TMYDubai.WindSpeedms(1:n,:),'pressure_atm',TMYDubai.PressurePa(1:n,:),...
					'rain',TMYDubai.Rain(1:n,:),'rel_humidity',...
					TMYDubai.RH(1:n,:)./100,'Date',TMYDubai.Time(1:n,:));
