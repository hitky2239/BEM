%%%%%%%%%% RUN TIME SERIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load(fullfile('+data_functions', 'TMYNewDelhi_RadPart.mat'))

% Decide if a varying LAI timeseries is provided [1] or not [0]
[LAI_TimeSeries]=data_functions.VaryingLAIInput(0,'LAI_Zurich_Area'); 


n			=	size(TMYNewDelhi,1); % Calculation length, there is no need to change this
m			=	1;					% Length for sensitivity analysis
Name_Site	=	'ND_LCZ3';	% Name for Data_UEHM_site
Name_SiteFD	=	'ND_LCZ3';		% Name for UEHMForcingData
Name_ViewFactor = 'ND_LCZ3';
...
TMYNewDelhi.WindSpeedms(TMYNewDelhi.WindSpeedms(1:n,:)==0) = 0.01;	% Wind speed cannot be 0 otherwise the resistance function fails

MeteoDataRaw	=	struct('LWR_in',TMYNewDelhi.LWRin(1:n,:),'SAB1_in',TMYNewDelhi.SAB1(1:n,:),...
					'SAB2_in',TMYNewDelhi.SAB2(1:n,:),'SAD1_in',TMYNewDelhi.SAD1(1:n,:),...
					'SAD2_in',TMYNewDelhi.SAD2(1:n,:),'T_atm',TMYNewDelhi.TairC(1:n,:)+273.15,...
					'windspeed_u',TMYNewDelhi.WindSpeedms(1:n,:),'pressure_atm',TMYNewDelhi.PressurePa(1:n,:),...
					'rain',TMYNewDelhi.Rain(1:n,:),'rel_humidity',...
					TMYNewDelhi.RH(1:n,:)./100,'Date',TMYNewDelhi.Time(1:n,:));
